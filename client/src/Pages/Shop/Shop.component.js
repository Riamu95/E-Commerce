  ...
  return (
    <div>
      <Route
        ...
        path={`${match.path}`}
        render={(props) => (
          <CollectionsOverviewSpinner isLoading={isLoading} {...props} />
        )}
      />
      <Route
        exact
        ...
        render={(props) => (
          <CollectionsPageSpinner isLoading={isLoading} {...props} />
        )}
      />
      <Route
        path={`${match.path}/:collectionId/:itemId`}
        render={(props) => <ItemPageSpinner isLoading={isLoading} {...props} />}
      />
    </div>
  );
};
